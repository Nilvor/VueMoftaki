    ...
    <div class="p-body">
      <div class="d-flex header_addres">
        <router-link :to="{name:'HomePage'}">
          <img class="svg_back" src="../assets/img/back.svg">
        </router-link>
        <div class="font-6 center_navbars">پر بازدیدترین محصولات</div>
      </div>
...
export default {
  ...
  setup() {
    ...
    axios.get(url_base + 'sort_products', {params: {action: 3, page: 1}})
