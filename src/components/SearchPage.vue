  ...
  <div id="main">
    <div class="p-body">
      <div class="d-flex header_addres">
        ...
        <div class="font-6 center_navbars"> جست و جو برای {{ search }} </div>
      </div>
        ...
        <div class="grid-container high_seller">
          <div v-for="item in products" :key="item.id" class="item-product bg-gray">
            ...
            <div class="d-flex align-items-center justify-content-around mt-1" style="width: 70px">
              ...
              <img v-else @click="PlusProduct(item)" class="svg-add add_min_btn" src="../assets/img/pluss_right.png" alt="">
...
export default {
  ...
  setup() {
    ...
    var search = useRoute().params.search;
    var store = useStore();
    ...
    loading.value = true
    axios.get(url_base + 'search_bar', {params: {name: search, page: 1}})
    ...
    return {loading,search, products,orders_count,orders_price,PlusProduct,MinusProduct,UserValidate}
  }
}
</script>
